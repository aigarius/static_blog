...
[BMW i4](https://aigarius.com/blog/2022/06/29/long-travel-in-an-electric-car/),
I switched to the
[BMW i5](https://www.bmw.de/de/neufahrzeuge/bmw-i/i5/bmw-i5-ueberblick.html). In
...
is added on top of the power that the rear motor provides. There _are_ motors
...
fair, BMW cars -- especially the i5 M60 -- feel _extremely_ stable and safe at
speeds over 200 km/h, so for some people in Germany, that could be a real
argument for an M-Performance car. It also does not consume _all_ that much more
...
that an electric motor allows makes a BEV RWD car drive _almost_ as easily in
...
The rear seat of the i5 is also _far_ more usable for adult passengers. One can
...
for comfort seats in the front, and I enjoyed that a _lot_. Three years ago, I
...
happen, and before roundabouts. It also slows down _in advance_ of known
...
_start_ to slow down a couple of seconds _after_ passing the speed limit sign.

![BMW i5 in mountains](mountains.jpg)
...
driver's gaze even more strictly in this mode -- you _have to_ watch the road.
...
BMW retains the concept of _cooperative driver assistance_ here -- the car is
not taking over the full driving _from_ you; it is cooperating _with_ you. So,
for example, while driving on the highway with full cruise control and lane
keeping enabled, I can still _lightly_ tug on the steering wheel left to make
...
Another thing that often stays unremarked is that BMW is managing the _largest_
...
charge level of my car's battery _without_ having to explicitly go somewhere
_just_ to charge.
...
This is going to be a BIG deal. In this generation, _everything_ is new and
...
basically the only design choice. The NK design _can_ include range-extending
...
cars, feels like a generation was skipped. It is _two_ generations ahead of
...
[already published](https://www.bmwgroup.com/en/news/general/2025/newidrive.html).
...
[week at CES](https://www.youtube.com/watch?v=rufP0k3oaMg), there is a local LLM
...
[here](https://bsky.app/profile/aigarius.com/post/3mcatiey3k22z) or
[here](https://www.threads.com/@aigarius/post/DTbF_ocjl10).
